...
function Faq() {
  return (
    <div>
      <p className="bg-black bg-opacity-95 pt-20 pb-40 text-5xl text-white font-bold text-center">
      ...
      <main className="min-h-screen flex flex-col items-center justify-center bg-black bg-opacity-95 ">
        ...
        <Accordian className="max-w-[1500px] bg-black bg-opacity-95 text-white">
          ...
          <AccordianItem value="4" trigger="Do you offer any mentorship or career guidance programs?">
